          ...
          <tr>
           ...
           <tr>
            ...
            <tr>
             ...
             <table>
             <tr>
              <td style="text-align:center;"><?php echo ucfirst(i18n("ordered"));?></td>
              <td style="text-align:center;"><?php echo ucfirst(i18n("used"));?></td>
              <td style="text-align:center;"><?php echo ucfirst(i18n("colBilled"));?></td>
             </tr>
             <tr>
               <td>
