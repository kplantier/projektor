...
$version = "V9.4.1"; // Version of application : Major / Minor / Release
$build = "0300"; // Build number. To be increased on each release
...
if (!(isset($maintenance) and $maintenance) and !(isset($batchMode) and $batchMode) and !(isset($indexPhp) and $indexPhp)) {
  ...
  $pos=strrpos($page, "/");
  if(trim(getSessionValue('uniqueSessionId')) and (strrpos($page, "/tool") or strrpos($page, "/view")) and !(substr($page, strrpos($page, "/view/"))=='/view/main.php')){
...
function getWidthLayoutActivityStream($objectClass){
  ...
  $isObject=true;
  $arrayNotObj=array('Planning','GlobalPlanning','PortfolioPlanning','ResourcePlanning','VersionsPlanning','ContractGantt','HierarchicalBudget');
