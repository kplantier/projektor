...
?>
  ...
  <?php if ($isIE and $isIE<=9) {?>
    action="../tool/saveDocumentVersion.php?isIE=<?php echo ($isIE?1:0);?>&csrfToken=<?php echo getSessionValue('Token'); ?>"
      ...
      <tr height="30px"> 
        ...
        <td style="position:relative">
         ...
         <input MAX_FILE_SIZE="<?php echo Parameter::getGlobalParameter('paramAttachmentMaxSize');?>"
          ...
          url="../tool/saveDocumentVersion.php?csrfToken=<?php echo getSessionValue('Token'); ?>"
          name="documentVersionFile" id="documentVersionFile" 
          cancelText="<?php echo i18n("buttonReset");?>"
          <?php if (! $isIE) {?>
            style="padding:0px;margin:0px;<?php echo (isNewGui())?'width:280px':'z-index: 50;width:220px; border: 3px dotted #EEEEEE;';?>"
          <?php } else {?>
          ...
          label="<?php echo i18n("buttonBrowse");?>"
          title="<?php echo i18n("helpSelectFile");?>"  />
          <span style="font-style:italic;position: absolute; z-index: 49; top: 8px; left: 120px; color: #AAAAAA; width:200px;pointer-events: none;"><?php echo i18n("dragAndDropDocVersion");?></span>
          </span> 
         <?php }?>
      ...
      <tr> 
        ...
        <td> 
         <div dojoType="dijit.form.TextBox" 
          ...
          style="width: <?php echo (isNewGui())?'267px':'200px';?>;" readonly
          maxlength="100"
          class="input">  
         </div>  
        </td>
      ...
      <tr> 
        ...
        <input id="oldDocumentVersionNewVersionDisplay" name="oldDocumentVersionNewVersionDisplay"  value="" hidden/>
         <div dojoType="dijit.form.TextBox" 
          ...
          style="width: <?php echo (isNewGui())?'267px':'200px';?>;" readonly required
          maxlength="100"
          class="input">  
         </div>  
        </td>
      ...
      <tr>
        ...
        <td>
          ...
          <?php echo autoOpenFilteringSelect();?>
                ...
                class="input" value="" 
                onChange="" style="width:<?php echo (isNewGui())?'267px':'200px';?>;"
