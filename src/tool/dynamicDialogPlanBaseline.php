           ...
           <tr>
             ...
             <td>
               ...
               if ($mode=='edit') echo 'readonly';?>
                id="idProjectPlanBaseline" name="idProjectPlanBaseline"  data-dojo-props="queryExpr: '*${0}*',autoComplete:false"
                class="input required" required >
                 ...
                 <script type="dojo/connect" event="onChange" args="evt">
                   dojo.xhrGet({
                     url : '../tool/getSingleData.php?dataType=count&class=Baseline&param1=idProject&value1='+this.value+'&csrfToken='+csrfToken,
                     handleAs : "text",
                     load : function(data) {
                        if (parseInt(data)>0) {
                   ...
                   dojo.xhrGet({
                     url : '../tool/getSingleData.php?dataType=count&class=Baseline&param1=idProject&value1='+this.value+'&param2=baselineDate&value2=<?php echo date('Y-m-d');?>&csrfToken='+csrfToken,
                     handleAs : "text",
                     load : function(data) {
