...
$adminView=RequestHandler::getValue('adminView');
if (!$scope) return;
...
<tr>
  <td align="center" colspan="2">
    ...
    <button class="mediumTextButton"  id="dialogCronDefinitonSubmit" dojoType="dijit.form.Button" type="submit" onclick="protectDblClick(this);cronExecutionDefinitionSave('<?php echo $adminView;?>');return false;">
