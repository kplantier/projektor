  ...
  public function getValidationScript($colName) {
    $colScript = parent::getValidationScript($colName);
     ...
     if ($colName=="idResource") {   
      ...
      $colScript .= '      url: "../tool/getSingleData.php?dataType=resourceProfile&idResource=" + this.value+"&csrfToken="+csrfToken,';
...
// TEST - New - Stop
  ...
  public function control(){
    ...
    if (!$this->idProfile or trim($this->idProfile)=='') {
      if(!$affectable->idProfile or trim($affectable->idProfile)==''){
