...
class Absence{
  ...
  public $idProject;
  public $idActivity;
  public static $_colorTab=array('#f08080','#D83C0A','#0060B0','#B3B6B7','#00D8D8','#E3E311',
                                 '#E35656','#00B5FF','#0010B0','#FEFE8B','#FF3E00','#87ceeb',
                                 '#DE8500','#A0ffA0','#BA8DC9','#6CB96C','#00F900','#3CCC3C',
                                 '#ff66ff','#ffc266','#FF9900','#D6A1D4','#FF00AA','#FDFD00',
