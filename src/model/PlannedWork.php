...
//       }
      ...
      $realProfile=$profile; // Store the real profile for START, that is set to ASAP but should respect Validated Start Date, even with E-E dependency 
...
//          $idxAss=0;
          ...
          foreach ($listAss as $keyAss=>$ass) {
            ...
            if ($startPlan>$startDate) {
              ...
              if ($step==-1) {
                if ($realProfile=='START') $currentDate=$plan->validatedStartDate;
                $step=1;
              }
            }
            if ($profile=='GROUP') {
            ...
            while (1) {
              if ($realProfile=="START" and $currentDate<$plan->validatedStartDate and $step==-1) {
