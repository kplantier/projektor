...
class OutgoingMailMain extends SqlElement {
  ...
  private static $_colCaptionTransposition = array('idResponsible'=> 'responsible','idDeliveryMode'=>'receiveMode','idDeliveryMode'=>'sendMode');
...
// ============================================================================**********
  ...
  public function save() {
    ...
    if($this->id){
      ...
      if($this->idClient and trim($address) == ""){
      ...
      if($this->idProvider and trim($address) == ""){
