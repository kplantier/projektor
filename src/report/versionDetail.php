...
foreach ($lstVersion as $versId=>$versName) {
  ...
  $cpt=0;
    ...
    foreach ($lst as $item) {
      ...
      echo '<td class="largeReportData" style="width:10%"><div>' . formatColor('Status', $item->idStatus) . '</div></td>';
      ...
      echo '<td class="largeReportData" style="width:100px"><div>' . ((isset($item->idPriority))?formatColor('Priority', $item->idPriority):'') . '</div></td>';
