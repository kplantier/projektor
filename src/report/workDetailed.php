...
foreach ($lstWork as $work) {
  ...
  if (!$paramActivityType or (isset($act) and ($paramActivityType == $act->idActivityType))) {
    ...
    if (!isset($activityRes[$work->idResource])) $activityRes[$work->idResource]=array();
    if (!isset($activityRes[$work->idResource][$work->refId]))$activityRes[$work->idResource][$work->refId]=array();
    if (!isset($activityRes[$work->idResource][$work->refId][$work->idProject]))$activityRes[$work->idResource][$work->refId][$work->idProject]=0;
