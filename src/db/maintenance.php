...
$versionHistory = array(
  ...
  "V9.0.0", "V9.0.2", "V9.0.3", "V9.0.5", "V9.1.0", "V9.1.1", "V9.1.2", "V9.2.0", "V9.2.1", "V9.3.0", "V9.3.1", "V9.3.2", "V9.3.3", "V9.4.0", "V9.4.1"
);
...
if (beforeVersion($currVersion,"V9.3.3") ) {
  error_reporting(0);
  enableCatchErrors();
  enableSilentErrors();
  $locItem=new LocalizationItem();
  disableSilentErrors();
  if (Sql::$lastQueryErrorCode) {
