              ...
              <tr height="30px"> 
                ...
                <td style="text-align:left;width;200px" >
                 ...
                 <div MAX_FILE_SIZE="<?php echo Parameter::getGlobalParameter('paramAttachmentMaxSize');?>"
                  ...
                  url="../tool/uploadPlugin.php?csrfToken=<?php echo getSessionValue('Token');?>"
...
function displayInstalledPlugin() {
  ...
  if (count($plList)==0) {
    ...
    echo '<tr>';
    echo '<td style="width:5%" class="noteHeader"></td>';
    echo '<td style="width:20%" class="noteHeader">'.i18n("colName").'</td>';
    echo '<td style="width:35%" class="noteHeader">'.i18n("colDescription").'</td>';
    ...
    foreach ($plList as $plugin) {
      echo '<tr>';
      echo '<td class="noteData"><a onClick="uninstallPlugin(\''.$plugin->uniqueCode.'\', \''.$plugin->name.'\');" title="' . i18n('buttonDeletePluginFile') . '"  /> '.formatSmallButton('Remove').'</a></td>';
