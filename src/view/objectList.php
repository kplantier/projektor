...
&csrfToken=<?php echo getSessionValue('Token');?>
...
<?php if ( property_exists($obj,'isEis') and !$hideEisSearch) { ?>
              ...
              <?php }?> 
<?php if (! $hideShowIdleSearch and ! $comboDetail and !($objectClass=='Project' and !$showIdle)) {?> 
...
<?php } else {?>
       ...
       <td style="text-align: right; width:10%; min-width:60px;width:80px;white-space:normal;" class="allSearchTD idleSearchTD allSearchFixLength">
        <div>&nbsp;</div>
      </td>
<?php }?>           
          </tr>
