    ...
    <?php echo autoOpenFilteringSelect();?>
     ...
     >  
       <?php $projObj = new Project();
             htmlDrawOptionForReference('idProject', $defaultValue,$projObj, false,null,null,$limitToActiveProjects,false,$showIdle); ?>
...
?>
    ...
    <?php echo ($param->multiple == 1) ? '' : autoOpenFilteringSelect(); ?>
       ...
       id="<?php echo $param->name;?>" name="<?php echo $param->name . (($param->multiple == 1) ? '[]' : '');?>"
     >
       <?php htmlDrawOptionForReference('id'.$class, $defaultValue, null, ($class=='Baseline' || $param->multiple)); ?>
     </select>     
    </td>
    </tr>
<?php 
