      ...
      <table style="width:100%;height:100%;">
        <tr style="height:35px;">
          ...
          <td style="width:43px;min-width:43px;max-width:43px;">&nbsp;
            ...
            <div style="position:absolute; top:2px;left:<?php echo ($drawHideDetail)?'48px':'0';?> ;" class="icon<?php echo $iconClassName;?>32 icon<?php echo $iconClassName;?> iconSize32" style="margin-left:9px;width:32px;height:32px" /></div>          
          </td>
       ...
       iconClass="dijitButtonIcon dijitButtonIconNew" class="detailButton">
        <script type="dojo/connect" event="onClick" args="evt">
          ...
          var objectClass=dojo.byId('objectClass').value;
            ...
            if(currentItem && currentItem[0] == currentScreen)return;
